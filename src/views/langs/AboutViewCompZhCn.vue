<template>
  ...
  <p>
    本站与<span lang="ja">ブルーアーカイブ</span>（<span lang="en">Blue Archive</span>、<span
      lang="zh_CN"
      >蔚蓝档案</span
    >）、Yostar、Nexon与Nexon Games没有任何形式关联。
  </p>
  ...
  <ul class="ul-compact">
    ...
    <li>
      <a href="https://developers.google.com/analytics/">Google Analytics</a>， 用于匿名访问数据收集
    </li>
  ...
  <h2>联系我们</h2>
  <p>
    GitHub：<a href="https://github.com/BA-L10N-Viewer/">项目主页</a>、<a
      href="https://github.com/BA-L10N-Viewer/viewer_site/"
      >站点Repo</a
    >、<a href="https://github.com/orgs/BA-L10N-Viewer/discussions/">讨论版</a>
  </p>
  <p>
    主要开发者（@sctop）：<a href="https://github.com/sctop/">GitHub</a>、<a
