<template>
  <h1>Disclaimer</h1>
  <p>
    This site is not affilicated in any forms with Blue Archive (<span lang="ja"
      >ブルーアーカイブ</span
    >), Yostar, Nexon and Nexon Games.
  </p>
  <p>
  ...
  <ul class="ul-compact">
    ...
    <li><a href="https://cloudflare.com/">CloudFlare</a> - CDN Provider for the Main Site</li>
    <li>
      <a href="https://aws.amazon.com/cloudfront/">CloudFront</a> - CDN Acceleration for China
      Mainland
    </li>
    <li>
      <a href="https://developers.google.com/analytics/">Google Analytics</a> - Access Data Analysis
    </li>
    <li>
      <a href="https://clarity.microsoft.com/">Microsoft Clarity</a> - Access Behavior Analysis
    </li>
  </ul>
  ...
  <h2>Contact Us</h2>
  <p>
    GitHub：<a href="https://github.com/BA-L10N-Viewer/">Project Homepage</a>、<a
      href="https://github.com/BA-L10N-Viewer/viewer_site/"
      >Repo for the Site</a
    >、<a href="https://github.com/orgs/BA-L10N-Viewer/discussions/">Discussions</a>
  </p>
  <p>
    Main Developer (@sctop): <a href="https://github.com/sctop/">GitHub</a>,
    <a href="https://twitter.com/KitePythonner">Twitter/X (@KitePythonner)</a>
  </p>
