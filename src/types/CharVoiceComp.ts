...
export type CharVoiceUiTabAvailabilityList = {
  value: CharVoiceUiTabName
  label: string
  disabled: boolean
}[]
...
export const symbolDataCharVoiceNexon = Symbol(
  'CharVoiceDataNexon'
) as InjectionKey<NexonCharVoiceEntry>
export const symbolDataCharVoiceSdb = Symbol(
  'CharVoiceDataSdb'
) as InjectionKey<SchaleDbStuInfoFullVoiceline>
export const symbolMtDataCharVoiceNexon = Symbol('CharVoiceMtDataNexon') as InjectionKey<
  Ref<NexonCharVoiceMtData>
>
export const symbolMtDataCharVoiceSdb = Symbol('CharVoiceMtDataSdb') as InjectionKey<
  Ref<SchaleDbStuVoicelineMtData>
>
export const symbolDataCharVoiceI18n = Symbol('CharVoiceMtDataI18n') as InjectionKey<
  ShallowRef<{ [key: string]: string }>
>
