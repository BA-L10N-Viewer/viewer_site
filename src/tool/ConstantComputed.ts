...
export const langsOfSelectedLangForMobile = computed(() => {
  ...
  for (const pos of listOfPosOfSelectedLangForMobile.value) lang.push(i18nLangAll.value[pos])
  return lang
})
...
export const mtI18nLangStats: ComputedRef<[string, string, string, string, string]> = computed(
  () => {
    ...
    return [mtPinia.i18n_l1, mtPinia.i18n_l2, mtPinia.i18n_l3, mtPinia.i18n_l4, mtPinia.i18n_l5]
  }
)
