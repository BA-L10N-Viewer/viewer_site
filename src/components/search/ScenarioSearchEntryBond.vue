...
import type { I18nBondInfoDataEntry, NexonL10nData } from '@/types/OutsourcedData'
...
<template>
  <h3>
    <MomotalkHeader :data_mmtid="data.id" :data_no="data_no - 1" :data_l10n="data.data[0]" :data_l10n_mt="dataMt" :is_l2d="isL2d"/>
  </h3>
  <ul>
